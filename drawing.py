...
def drawCross(img, params, center=(100, 100), scale=30.0):
    ...
    cv2.line(img, (center[0], center[1]), (points2D[0, 0], points2D[0, 1]), (255, 255, 255), 3)
    cv2.line(img, (center[0], center[1]), (points2D[1, 0], points2D[1, 1]), (255, 255, 255), 3)
    cv2.line(img, (center[0], center[1]), (points2D[2, 0], points2D[2, 1]), (255, 255, 255), 3)
...
def drawMesh(img, shape, mesh, color=(255, 0, 0)):
    for triangle in mesh:
        ...
        cv2.line(img, (point1[0], point1[1]), (point2[0], point2[1]), (255, 255, 255), 1)
        cv2.line(img, (point2[0], point2[1]), (point3[0], point3[1]), (255, 255, 255), 1)
        cv2.line(img, (point3[0], point3[1]), (point1[0], point1[1]), (255, 255, 255), 1)
